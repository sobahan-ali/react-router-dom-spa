...
const Product = () => {
    ...
    // console.log(product);
    const { images, description, brand, price } = product;
    return (
        <div className="">
            <div className="h-96 mx-auto mt-10 w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
